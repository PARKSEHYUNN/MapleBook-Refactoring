/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: ac87240eb611abe81bbb9366d2e12f65)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXON_API_SERVICE_KEY: string;
		TEST_ACCOUNT_SECRET: string;
		WORKER_SELF_REFERENCE: Fetcher /* maplebook */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "COOKIE_SECRET" | "NEXON_API_SERVICE_KEY" | "TEST_ACCOUNT_SECRET">> {}
}
