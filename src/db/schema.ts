...
import { int, text, sqliteTable, AnySQLiteColumn, real, check, unique, primaryKey, index } from "drizzle-orm/sqlite-core";
...
export const characters = sqliteTable("characters", {
  ...
  beautyEquipmentJson: text("beauty_equipment_json", { mode: "json" }).$type<BeautyEquipmentJsonType>(),
  ...
  ringReserveSkillJson: text("ring_reserve_skill_json", { mode: "json" }).$type<RingReserveSkillEquipmentJsonType>(),
  defaultSettings: text("default_settings", { mode: "json" }).$type<DefaultSettingsJsonType>().$defaultFn(() => DefaultSettings),
  bio: text("bio"),
...
export const characterSnapshots = sqliteTable("character_snapshots", {
  id: int("id").primaryKey({ autoIncrement: true }),
  characterId: int("character_id").notNull().references(() => characters.id),
...
export const guilds = sqliteTable("guilds", {
  ...
  guildMasterId: int("guild_master_id").notNull().references(() => characters.id),
...
export const reviews = sqliteTable("reviews", {
  ...
  targetId: int("target_id").notNull().references(() => characters.id),
...
export const reviewReports = sqliteTable("review_reports", {
  id: int("id").primaryKey({ autoIncrement: true }),
  reporterId: int("reporter_id").notNull().references(() => users.id),
  reviewId: int("review_id").notNull().references(() => reviews.id),
